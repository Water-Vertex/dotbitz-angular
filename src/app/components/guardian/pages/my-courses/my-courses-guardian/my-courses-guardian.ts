...
import { CoursesByStudentsService } from '../../../../../services/coursesbystudents.service';
...
@Component({
  ...
  templateUrl: './my-courses-guardian.html',
  styleUrls: ['./my-courses-guardian.css'],
})
export class MyCoursesGuardian implements OnInit, OnDestroy {
  ...
  constructor(
    private coursesService: CoursesByStudentsService,

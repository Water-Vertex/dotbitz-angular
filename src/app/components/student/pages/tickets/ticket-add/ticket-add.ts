...
export class StudentSupportTickets implements OnInit {
  ...
  // User info — localStorage ya auth service se
  userName  = '';
  userEmail = '';
  ...
  loadUserInfo(): void {
    // localStorage se user info load karo
    try {
  ...
  onSubmit(): void {
    if (!this.phone.trim()) { alert('Please enter your phone number.'); return; }

...
@Component({
  selector: 'app-guardian-reset-password',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './guardian-reset-password.html',
})
export class GuardianResetPassword implements OnInit {
  ...
  validateToken(): void {
    ...
    this.authService.validateGuardianResetToken({
      token: this.token,
      email: this.email
    }).subscribe({
      next: (response: any) => {
  ...
  onResetPassword(): void {
    if (this.resetPasswordForm.valid) {
      ...
      this.authService.guardianResetPassword({
        email: this.email,

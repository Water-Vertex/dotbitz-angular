...
@Component({
  selector: 'app-guardian-forgot-password',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './guardian-forgot-password.html',
})
export class GuardianForgotPassword {
  ...
  onSubmit(): void {
    if (this.forgotPasswordForm.valid) {
      ...
      this.authService.guardianForgotPassword(this.forgotPasswordForm.value).subscribe({
        next: (response: any) => {
          if (response.success) {

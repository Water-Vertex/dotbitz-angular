...
@Component({
  selector: 'app-instructor-forgot-password',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './instructor-forgot-password.html',
})
export class InstructorForgotPassword {
  ...
  onSubmit(): void {
    if (this.forgotPasswordForm.valid) {
      ...
      this.authService.instructorForgotPassword(this.forgotPasswordForm.value).subscribe({
        next: (response: any) => {
          if (response.success) {

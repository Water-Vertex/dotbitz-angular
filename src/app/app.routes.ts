...
import { StudentCourseDetail } from './components/student/pages/course/course-detail/course-detail';
import { GuardianCourseList } from './components/guardian/pages/course/course-list/course-list';
import { CourseDetailComponent } from './components/guardian/pages/course/course-detail/course-detail';
...
export const routes: Routes = [
  ...
  { path: 'guardian/login', component: GuardianLogin },
  {
    ...
    children: [
      ...
      { path: 'guardian/course/list', component: GuardianCourseList },
      { path: 'guardian/course/detail/:id', component: CourseDetailComponent},
